...
def shipping_elements_subscribed(stage_callback):
    framework_logger.info("=== C56333284 - Shipping elements Subscribed started ===")
    ...
    with PlaywrightManager() as page:
        try:
            ...
            framework_logger.info("=== C56333284 - Shipping elements Subscribed finished ===")
