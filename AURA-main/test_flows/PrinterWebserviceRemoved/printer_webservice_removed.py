...
def printer_webservice_removed(stage_callback):
    framework_logger.info("=== C39062014 - Printer webservice removed flow started ===")
    common.setup()
    ...
    with PlaywrightManager() as page:
        try:
            ...
            # Disable webservices
            common.remove_printer_webservices(printer.entity_id)
            framework_logger.info(f"Removed printer {printer.entity_id} via webservice")
            ...
            framework_logger.info(f"Finished enrollment successfully")

            # Access Overview page
            DashboardHelper.first_access(page, tenant_email)
            framework_logger.info(f"Accessed Overview page for tenant: {tenant_email}")

            framework_logger.info("=== C39062014 - Printer webservice removed flow completed successfully ===")
