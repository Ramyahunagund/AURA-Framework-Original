...
def replace_an_existing_printer_only_one_enrolled_printer(stage_callback):
    framework_logger.info("=== C38237958 - Replace an existing printer Only one enrolled printer flow started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            framework_logger.info("=== C38237958 - Replace an existing printer Only one enrolled printer flow finished ===")
