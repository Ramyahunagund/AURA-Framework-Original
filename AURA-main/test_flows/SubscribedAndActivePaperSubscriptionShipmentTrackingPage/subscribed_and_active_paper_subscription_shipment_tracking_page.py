...
def subscribed_and_active_paper_subscription_shipment_tracking_page(stage_callback):
    framework_logger.info("=== C30340460 - Subscribed and Active Paper Subscription Shipment Tracking Page flow started ===")
    common.setup()
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            expect(shipment_tracking_page.paper_tracking_item).to_be_visible()
            expect(shipment_tracking_page.paper_tracking_item).to_contain_text("Not available yet")
            framework_logger.info("Shipment Tracking page verified")

            framework_logger.info("=== C30340460 - Subscribed and Active Paper Subscription Shipment Tracking Page flow finished successfully ===")
        except Exception as e:
