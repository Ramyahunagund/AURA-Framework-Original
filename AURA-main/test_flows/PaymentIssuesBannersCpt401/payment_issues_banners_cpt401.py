...
def payment_issues_banners_cpt401(stage_callback):
    framework_logger.info("=== C44461319 - Payment Issues banners CPT-401 flow started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            # Set status code from CPT-201 to CPT-401 on billing cycle page
            GeminiRAHelper.click_billing_cycle_by_status(page, "CPT-201")
            GeminiRAHelper.set_status_code(page, "CPT-401")
            framework_logger.info("Set status code to CPT-401")
        
            # See Status code equals to CPT-401 on Billing cycle page
            GeminiRAHelper.verify_rails_admin_info(page, "Status code", "CPT-401")
            ...
            framework_logger.info("=== C44461319 - Payment Issues banners CPT-401 flow finished ===")
