...
def plan_change_as_of_next_month(stage_callback):
    framework_logger.info("=== C52050946 - Plan Change as of next month flow started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            update_plan.upgrade_next_month.click()
            ...
            PrintHistoryHelper.see_notification_on_print_history(page, "Plan change requested: HP Instant Ink service")
            ...
            framework_logger.info("=== C52050946 - Plan Change as of next month flow finished ===")
