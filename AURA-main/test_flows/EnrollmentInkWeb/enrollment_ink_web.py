# test_flows/EnrollmentInkWeb/enrollment_ink_web.py
...
def enrollment_ink_web(stage_callback):
    framework_logger.info("=== Enrollment Ink Web flow started ===")
    common.setup()
    ...
    with PlaywrightManager() as page:
        try:
            ...
            framework_logger.info("Ink web enrollment completed successfully")
            return tenant_email
