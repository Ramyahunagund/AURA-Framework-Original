...
def cancellation_transfer_subscription_to_another(stage_callback):
    framework_logger.info("=== C40797069 - Cancellation Transfer this subscription to another printer flow started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            CancellationPlanHelper.validate_transfer_subscription_contact_support_link(page,section_title="Transfer to other printer")
            framework_logger.info("Validated Transfer to other printer link on Cancellation Summary Page")

            framework_logger.info("=== C40797069 - Cancellation Transfer this subscription to another printer flow completed ===")
