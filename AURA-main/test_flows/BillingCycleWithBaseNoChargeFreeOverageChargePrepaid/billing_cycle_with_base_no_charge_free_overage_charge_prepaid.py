...
def billing_cycle_with_base_no_charge_free_overage_charge_prepaid(stage_callback):
    framework_logger.info("=== C39479307 - Billing Cycle with BaseNoCharge and FreeOverageCharge Prepaid started ===")
    common.setup()
    ...
    with PlaywrightManager() as page:
        try:
            ...
            framework_logger.info("=== C39479307 - Billing Cycle with BaseNoCharge and FreeOverageCharge Prepaid successfully ===")
