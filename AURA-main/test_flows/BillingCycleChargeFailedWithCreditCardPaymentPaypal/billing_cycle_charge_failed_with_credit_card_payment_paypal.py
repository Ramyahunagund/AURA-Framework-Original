...
def billing_cycle_charge_failed_with_credit_card_payment_paypal(stage_callback):
    framework_logger.info("=== C49152724 - Billing Cycle Charge Failed with CC payment - Paypal started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            framework_logger.info("=== C49152724 - Billing Cycle Charge Failed with CC payment - Paypal finished ===")
