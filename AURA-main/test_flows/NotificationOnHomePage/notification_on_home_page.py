...
def notification_on_home_page(stage_callback):
    framework_logger.info("=== C37830299 - Notification On Home Page started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
            ...
            framework_logger.info("=== C37830299 - Notification On Home Page finished ===")
