...
def enroll_or_replace_a_printer_button_and_link_for_subscribed_account(stage_callback):
    framework_logger.info("=== C48993544 - Enroll or replace a printer button and link for Subscribed account flow started ===")
    ...
    with PlaywrightManager() as page:
        ...
        try:
           ...
           # Click login button in the session expired modal on the Smart Dashboard
            ...
            framework_logger.info("=== C48993544 - Enroll or replace a printer button and link for Subscribed account flow finished ===")
